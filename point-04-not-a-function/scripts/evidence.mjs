 ...
 * ----------------------
 * Every claim this project makes about property-name checking must be
...
console.log(
  `\n${C.green}${C.bold}✔ ${total} property-name errors were caught at COMPILE TIME.${C.reset}`,
);
console.log(
  `${C.dim}  Zero of these programs ever reached Node. In JavaScript, each typo\n` +
    `  would have returned 'undefined' silently and crashed somewhere else.${C.reset}\n`,
);
